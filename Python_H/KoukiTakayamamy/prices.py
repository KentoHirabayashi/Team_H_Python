...
if(hm_class == "果物類"):
    price_down_items = fruits


if(hm_class == "酒類"):
    price_down_items = alcohol


if(hm_class == "麺類"):
    price_down_items = noodles


for i in price_down_items:
    for n,m in hinmoku.items():
        if(i == n):
            hinmoku[n] = hinmoku[n] - price_down
