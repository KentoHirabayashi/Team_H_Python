...
#品目（品名と価格）を辞書型で定義
hinmoku = {"リンゴ":80 , "みかん":198, "バナナ":150, "ビール":360, "日本酒":580, 
...
if hm_class == "果物類":
    hinmoku[fruits] = fruits - price_down
if hm_class == "酒類":
    hinmoku[alcohol] = alcohol- price_down
if hm_class == "麺類":
    hinmoku[noodles] = hinmoku[noodles]- price_down
